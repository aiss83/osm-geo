...
1. **Коррекция опечаток** (SymSpell) — по частотному словарю русского языка (`ru_full.txt`, ~1.4M слов, 28 МБ). Словарь включён в репозиторий; при его отсутствии скачивается автоматически. Исправляет типичные опечатки: «Масква» → «Москва».
...
2. **Нормализация падежей типов улиц** — сам тип улицы в косвенном падеже приводится к именительному:
   «проспекту» → «проспект», «улицы» → «улица», «переулка» → «переулок».

3. **Согласование прилагательных** — исправление ошибок OSM, где прилагательное стоит в родительном падеже вместо именительного. Работает для любых кириллических существительных (не только для типов улиц):
   - Род существительного определяется по окончанию: -а/-я → женский, -о/-е → средний, согласная → мужской
   - Прилагательное на -ой/-ей приводится к именительному падежу нужного рода
   
   Примеры: «Калининградской улица» → «Калининградская улица», «Калининградской зоопарк» → «Калининградский зоопарк».

4. **Нормализация регистра** — тип улицы приводится к нижнему регистру: «улица Ленина», «Центральная улица». Остальные названия — регистр предложения: «Красная площадь».
